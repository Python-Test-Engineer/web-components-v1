		...
		btn.addEventListener('click', (e) => {
			...
			this.dispatchEvent(
				new CustomEvent('childOneClick', {
					detail:
						'[ONE] Child One can trigger an event and send data to parent that can be sent to Child Two by Parent -> Child communication as per previous examples - attributes or Public Method. <br><br>Properties are Not changed by Public Properties but by attribute change.',
					bubbles: true,
					composed: true,
				}),
			);
			...
			// We can hear other Component's Custom events
			const body = document.querySelector('body');
			body.addEventListener('childTwoClick', () => alert('Component  One heard childClickTwo event...'));
		});
	}
}
