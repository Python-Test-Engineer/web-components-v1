...
class ChildTwo extends HTMLElement {
	...
	connectedCallback() {
		...
		btn.addEventListener('click', (e) => {
			...
			this.dispatchEvent(
				new CustomEvent('childTwoClick', {
					detail:
						'[TWO] Child Two can trigger an event and send data to parent that can be sent to Child One by Parent -> Child communication as per previous examples - attributes or Public Method. ',
					bubbles: true,
					composed: true,
				}),
			);
